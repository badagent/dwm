...
/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "[MAIL]", "[IM]", "[RSS]", "[IRC]" };
...
static const Rule rules[] = {
	 ...
	 */
	/* class      instance    title       tags mask     isfloating   monitor borderpx isbackgroundapp*/
	{ "Gimp",     NULL,       NULL,       0,            1,           -1 ,	   1,	   0},
	{ "SomeApp",  NULL,       NULL,       1 << 8,       0,           -1 ,	   1,	   0},
	{ "trayer",   NULL,       NULL,       255,          1,           -1 ,	   0,	   1},
	{ "Hexchat",   NULL,       NULL,      1 << 8,       1,           -1 ,	   1,	   0},
	{ "st-256color",NULL,"newsboat",      1 << 7,       0,           -1 ,	   1,	   0},
	{ "Pidgin",   NULL,   NULL,	      1 << 6,       1,           -1 ,	   1,	   0},
	{ "Thunderbird",   NULL,   NULL,	      1 << 5,       1,           -1 ,	   1,	   0},
	{ "st-256color",   NULL,   "mutt",	      1 << 5,       0,           -1 ,	   1,	   0},
};
...
static const char *raisevolcmd[] = { "amixer","-q","sset","Master","2+","unmute",NULL};
static const char *lowervolcmd[] = { "amixer","-q","sset","Master","2-","unmute",NULL};
